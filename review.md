...
版本：**v1.2.8**（2026-09-21；v1.0 = 立卷，v1.1 = 值级对拍收口存档 + 引用索引补模板/覆盖率纪律，
...
v1.2.8 = **C-T12 结案**（复跑证伪：release 下 MoonBit 词法 33.84M tok/s vs C-FFI 15.42M；原 2.3–2.6× 系 debug 档口径）+ 性能分段现况（验证段占 81%）入册，见 §7）
