...
版本：**v1.2.6**（2026-09-21；v1.0 = 立卷，v1.1 = 值级对拍收口存档 + 引用索引补模板/覆盖率纪律，
...
v1.2.6 = **役 2 / 2b 恢复道入模 + `Caret` 转正**（声明门 `[type_mapping.recovery_close]` + 探针面同扩 D2；覆盖率 9939 → 9982、permille 906 → 907），见 §7）
